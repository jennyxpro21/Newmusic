...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/AASHIYANA_DPZ")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/ITZ_DIL_KI_BAAT")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/jennyxpro21/Newmusic.git")
